...
class ValidationError
{
	 ...
	 * wanted.
	 * 
	 * The source has been deprecated, the idea is that the source should be in 
	 * charge of aggregating errors generated by it and provide these to the 
	 * components that may need it.
	 * 
	 * @deprecated since version 0.1-dev 20180516
	 * @var mixed
	 */
	private $src;
	 ...
	 * 
	 * This field also became deprecated in favor of having an array of ValidationErrors
	 * in every ValidationException when it is raised.
	 * 
	 * @deprecated since version 0.1-dev 20180516
