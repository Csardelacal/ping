...
"use strict";
/*!******************************************!*\
  !*** ./resources/assets/js/user/show.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lysine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lysine */ "./node_modules/lysine/dist/lysine.js");
/* harmony import */ var lysine__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lysine__WEBPACK_IMPORTED_MODULE_0__);
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      for (var i = 0; i < data.payload.length; i++) {
        var view = new (lysine__WEBPACK_IMPORTED_MODULE_0___default().view)('ping');
        ...
        if (data.payload[i].media && data.payload[i].explicit && media) {
          ...
          cover.addEventListener('click', function (cover, media) {
            return function () {
